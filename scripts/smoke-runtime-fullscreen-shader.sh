...
PROJECT="compatibility/v0.1/projects/valid/fullscreen-shader.project.json"
PATCH="compatibility/v0.1/patches/valid/set-fullscreen-shader-source.patch.json"
